...
alpha = 7;          % Just Change this!!!!!!
% Data
Meg = 18; %[gr/mol] - Water Molecular Weight
Mru =  72; %[gr/mol] - Molecular weight of Repeating Unit
P0_LA = 2; %[mol/lit] - Lactic Acid Concentration
W0 = 0.1; %[mol/lit] - Water Concentration
N = 200; % Number of repeating unit
T = 150 + 273.15; %[K]
Pre = 101325; %[Pa] - Reactor Pressure
k_a = 10; %[-]     factor related to water removal
y_H2O = 0.01; %[-]
...
kpp = exp(-15115./T+33.36); %Pn+Pm (n,m>1)
...
%% Resolution Section
tspan = 0:0.1:1+alpha;   %integration domain
% Initial Condition
...
lambda1to0 = lambda1/lambda0;
lambda2to1 = lambda2/lambda1;
%% Results
disp(['The ratio of lambda 1 over lambda 0 equals to: ', num2str(lambda1to0)])
disp(['The ratio of lambda 2 over lambda 1 equals to: ', num2str(lambda2to1)])

% disp(['The Moment at t = ',num2str(1+alpha),' hr equals to:',num2str(lambda0(end))])
% disp(['The PDI at t = ',num2str(1+alpha),' hr equals to:',num2str(PDI(end))])
disp(['The Concentration of P1 at t = ',num2str(1+alpha),' hr equals to:',num2str(P(end,2)),' mol/lit'])
disp(['The Concentration of P2 at t = ',num2str(1+alpha),' hr equals to:',num2str(P(end,3)), 'mol/lit'])
disp(['The Concentration of P20 at t = ',num2str(1+alpha),' hr equals to:',num2str(P(end,21)), 'mol/lit'])

...
disp('Case 1:')
disp(['The value of Dpw_inst equals to: ', num2str(DPw_inst_1(end))])
disp(['The value of MW_inst equals to: ', num2str(Mw_av_inst_1(end)), ' gr/mol.'])
...
disp('')
disp('Case 2:')
disp(['The value of Dpw_inst equals to: ', num2str(DPw_inst_2(end))])
disp(['The value of MW_inst equals to: ', num2str(Mw_av_inst_2(end)), ' gr/mol.'])
